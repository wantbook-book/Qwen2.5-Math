...
if __name__ == '__main__':
    generate_result_file = Path("/pubshare/fwk/code/Qwen2.5-Math/evaluation/outputs/pubshare/fwk/orlhf_checkpoints/checkpoint/llama3-1b-porm_grpo_n16_8samples/math_eval/math/test_direct_-1_seed0_t0.0_s0_e-1.jsonl")
